...
func enviarCorreoConResend(
	...
	let correo = ResendEmail(
		from: "Instituto Tabasco <inscripciones@institutotabasco.edu.mx>", // O cualquier remitente verificado en Resend
        	to: [destinatario, "direcciongeneral@institutotabasco.edu.mx"],
        	subject: asunto,
        	html: cuerpoHTML
	)
